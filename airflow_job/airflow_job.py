...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="airflow-projects-gds-03012026")
    bq_project = Variable.get("bq_project", default_var="project-040088dd-8c9a-464e-96f")
    ...
    file_sensor = GCSObjectExistenceSensor(
        ...
        bucket=gcs_bucket,
        object=f"airflow-flight-booking-CICD-Project/source-{env}/flight_booking.csv",  # Full file path in GCS
    ...
    batch_details = {
        "pyspark_batch": {
            "main_python_file_uri": f"gs://{gcs_bucket}/airflow-flight-booking-CICD-Project/spark-job/spark_transformation_job.py",  # Main Python file
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "68634013284-compute@developer.gserviceaccount.com",
                "network_uri": "projects/project-040088dd-8c9a-464e-96f/global/networks/default",
                "subnetwork_uri": "projects/project-040088dd-8c9a-464e-96f/regions/us-central1/subnetworks/default",
            }
        },
    }
